...
import { districts, stats } from '../../data/content'
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[2] mx-auto flex w-full max-w-[1240px] flex-1 flex-col justify-center px-8 pt-[150px]">
        ...
        <h1 className="animate-mp-rise max-w-[17ch] font-tamil-serif text-[clamp(36px,5.6vw,74px)] leading-[1.1] font-bold tracking-[-0.5px] [text-shadow:0_2px_30px_rgba(0,0,0,0.25)] [animation-delay:0.1s]">
          முல்லைப் பெரியாறு ஒருபோக பாசன விவசாயிகள் சங்கம்
        </h1>
        <p className="animate-mp-rise mt-6 font-accent text-[clamp(19px,2.1vw,26px)] tracking-[0.3px] text-[#CFE2D4] italic [animation-delay:0.2s]">
          Mullai Periyar Single-Crop Irrigation Farmers' Association
        </p>
        <p className="animate-mp-rise mt-[26px] max-w-[56ch] text-[clamp(16px,1.45vw,19px)] leading-[1.75] text-[#DCEAE0] [animation-delay:0.3s]">
          பெரியாறு நீரை நம்பி வாழும் தென் தமிழ்நாட்டு விவசாயிகளின் உரிமைகளைப் பாதுகாக்கவும்,
          நீர்மட்டக் கோரிக்கைகளை மக்களுக்கு எடுத்துச் செல்லவும் ஒன்றிணைந்த ஒற்றைக் குரல்.
        </p>
