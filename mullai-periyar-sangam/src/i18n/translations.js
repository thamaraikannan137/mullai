export const translations = {
    ta: {
        ...
        hero: {
            ...
            description: 'பெரியாறு நீரை நம்பி வாழும் தென் தமிழ்நாட்டு விவசாயிகளின் உரிமைகளைப் பாதுகாக்கவும், நீர்மட்டக் கோரிக்கைகளை மக்களுக்கு எடுத்துச் செல்லவும் ஒன்றிணைந்த ஒற்றைக் குரல்.',
        ...
        leaders: {
            ...
            quote: 'பெரியாறு நீர் எங்கள் மூதாதையர் உழைப்பின் பலன். அந்த நீரை, அதன் முழு உரிமையை, அடுத்த தலைமுறைக்குக் கடத்துவதே எங்கள் சங்கத்தின் கடமை.',
        ...
        demands: {
            ...
            intro: 'பெரியாறு பாசனப் பகுதி விவசாயிகளின் வாழ்வாதாரத்தை உறுதி செய்யும் முக்கியக் கோரிக்கைகள். இவற்றை அரசின் கவனத்திற்கு தொடர்ந்து எடுத்துச் செல்கிறோம்.',
            items: [
                {
                    num: '01',
        ...
        join: {
            ...
            description: 'பெரியாறு பாசனப் பகுதி விவசாயிகளின் ஒற்றைக் குரலாக நாம் ஒன்றிணைவோம். உங்கள் விவரங்களைப் பதிவு செய்தால், சங்கத்தின் தொண்டர்கள் உங்களைத் தொடர்பு கொள்வார்கள்.',
            ...
            thanks: 'நன்றி',
            thanksMsg: 'உங்கள் பதிவு பெறப்பட்டது. சங்கத்தின் தொண்டர்கள் விரைவில் உங்களைத் தொடர்பு கொள்வார்கள்.',
            defaultName: 'நண்பரே',
        ...
        contact: {
            ...
            title: 'தொடர்பு கொள்ள',
            description: 'கோரிக்கைகள், உறுப்பினர் சேர்க்கை, நிகழ்வுத் தகவல்கள் — எதற்கும் சங்க அலுவலகத்தைத் தொடர்பு கொள்ளுங்கள். உங்கள் குரல் எங்கள் வலிமை.',
        ...
        footer: {
            description: 'பெரியாறு பாசனப் பகுதி விவசாயிகளின் உரிமைகளுக்கான ஒற்றைக் குரல். நீர், மண், வாழ்வாதாரம் — நம் உரிமை.',
            pagesTitle: 'பக்கங்கள்',
            districtsTitle: 'பாசன மாவட்டங்கள்',
            socialTitle: 'எங்களைப் பின்தொடருங்கள்',
            districts: ['தேனி', 'மதுரை', 'சிவகங்கை', 'ராமநாதபுரம்', 'திண்டுக்கல்'],
            copyright: '© 2026 முல்லைப் பெரியாறு ஒருபோக பாசன விவசாயிகள் சங்கம். அனைத்து உரிமைகளும் பாதுகாக்கப்பட்டவை.',
    ...
    en: {
        ...
        hero: {
            ...
            description: 'A united voice to protect the rights of South Tamil Nadu farmers who depend on Periyar water, and to carry water-level demands to the people.',
        ...
        leaders: {
            ...
            quote: 'Periyar water is the fruit of our ancestors\' labour. Passing that water, with its full rights, to the next generation is our association\'s duty.',
        ...
        demands: {
            sectionLabel: 'Our Demands',
            title: 'Our Demands',
            intro: 'Key demands to secure the livelihood of farmers in the Periyar command area. We continuously raise these with the government.',
            items: [
                {
                    num: '01',
        ...
        join: {
            ...
            description: 'Let us unite as the single voice of Periyar command-area farmers. Register your details and association volunteers will contact you.',
            ...
            submitBtn: 'Register →',
            thanks: 'Thank you',
            thanksMsg: 'Your registration has been received. Association volunteers will contact you shortly.',
            defaultName: 'friend',
        ...
        contact: {
            sectionLabel: 'Get in Touch',
            title: 'Contact Us',
            description: 'For demands, membership, or event information — contact the association office. Your voice is our strength.',
        ...
        footer: {
            description: 'The united voice for the rights of Periyar command-area farmers. Water, soil, livelihood — our right.',
            pagesTitle: 'Pages',
            districtsTitle: 'Irrigation Districts',
            socialTitle: 'Follow us',
            districts: ['Theni', 'Madurai', 'Sivagangai', 'Ramanathapuram', 'Dindigul'],
            copyright: '© 2026 Mullai Periyar Single-Crop Irrigation Farmers\' Association. All rights reserved.',
